...
describe("30. Publicar pagina ingresando excerpt oración.", function () {
...
function createPage(path, url) {
  ...
  const excerpt = faker.lorem.sentence();
  cy.wait(1000);
  ...
  cy.wait(1000);
  cy.get(".post-setting-custom-excerpt").type(excerpt).type("{enter}");
  cy.wait(1000);
  cy.get(
