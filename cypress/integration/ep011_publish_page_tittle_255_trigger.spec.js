...
describe("11. Publicar una página con titulo con más de 255 palabras y subtitulo, trigger.", function () {
...
function createPage(path, url) {
  const namePage1 = faker.lorem.sentence(55);
  var length = 256;
  var namePage = namePage1.substring(0, length);
  ...
  cy.get(".gh-editor-title.ember-text-area.gh-input.ember-view")
    ...
    cy.wait(1000);
  cy.get(
    ".gh-btn.gh-btn-outline.gh-publishmenu-trigger"
  ).click({force:true});
  cy.wait(1000);
  cy.get(".gh-btn.gh-btn-blue.gh-publishmenu-button.gh-btn-icon.ember-view")
    ...
    .click();
    cy.wait(1000);
    cy.get(".gh-alert.gh-alert-red.ember-view").contains("Saving failed: Title cannot be longer than 255 characters.").should("exist");
    cy.wait(1000);
}
