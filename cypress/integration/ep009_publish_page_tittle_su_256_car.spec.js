...
describe("9. Publicar una página con titulo oración subtitulo con más de 255 caracteres.", function () {
...
function createPage(path, url) {
  const namePage = faker.lorem.sentence();
  const subt = faker.lorem.sentence(255);
  cy.wait(1000);
